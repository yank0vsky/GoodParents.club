...
def resized_image(value, arg="full"):
    if not value or "://i.goodparents.club/" not in value:
        return value

    if is_video(value):
        return value

    if value.startswith("https://i.goodparents.club/full/"):
        return value.replace(
            "https://i.goodparents.club/full/", "https://i.goodparents.club/{}/".format(arg)
        )
    else:
        return value
