...
ALLOWED_HOSTS = ["*", "127.0.0.1", "localhost", "0.0.0.0", "goodparents.club"]
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "GoodParents.Club <club@goodparents.club>")

# App

APP_HOST = os.environ.get("APP_HOST") or "http://127.0.0.1:8000"
APP_NAME = "GoodParents Club"
APP_DESCRIPTION = "Всё самое интересное происходит за закрытыми дверями"
...
MEDIA_UPLOAD_URL = "https://i.goodparents.club/upload/multipart/"
MEDIA_UPLOAD_CODE = os.getenv("MEDIA_UPLOAD_CODE")
VIDEO_EXTENSIONS = {"mp4", "mov", "webm"}
IMAGE_EXTENSIONS = {"jpg", "jpeg", "png", "gif"}

OG_IMAGE_GENERATOR_URL = "https://og.goodparents.club/preview"
OG_IMAGE_DEFAULT = "https://goodparents.club/static/images/share.png"
OG_MACHINE_AUTHOR_LOGO = "https://goodparents.club/static/images/the_machine_logo.png"
OG_IMAGE_GENERATOR_DEFAULTS = {
    "logo": "https://goodparents.club/static/images/logo/logo-white-text.png",
    "op": 0.6,
    "bg": "#FFFFFF",
}
...
TELEGRAM_BOT_WEBHOOK_URL = "https://goodparents.club/telegram/webhook/"
...
DEFAULT_AVATAR = "https://i.goodparents.club/v.png"
...
CLEARED_POST_TEXT = "```\n" \
    ...
    "Если вы хотите приютить и развить эту тему как новый автор, напишите модераторам Клуба: moderator@goodparents.club." \
    "\n```"
